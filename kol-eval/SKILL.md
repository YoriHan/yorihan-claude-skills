---
name: kol-eval
description: "Deep KOL evaluation from Notion: scrape engagement, score CPM/ER/authenticity/pricing, output verdict (合作/小单测试/压价/不合作), write back to Notion. Needs the separate kol-eval Python tool. Trigger: 'kol-eval', '评估 KOL', 'KOL 价值评估', '该不该合作'."
---
