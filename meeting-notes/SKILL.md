---
name: meeting-notes
description: "Read a Feishu Minutes (妙记) / Tencent Meeting link or a raw transcript, auto-detect meeting type, then output: team meeting -> topic summary + per-person todos + open decisions; user interview -> structured interview outline (optional GitHub upload) + dev cheat-sheet (bug / cognition-gap / feature-priority tables). Trigger when: 'meeting-notes', '会议纪要', '整理会议', '整理访谈', '妙记', or pasting a meeting/transcript link."
---
